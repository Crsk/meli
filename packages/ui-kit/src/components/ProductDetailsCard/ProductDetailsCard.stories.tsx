...
export const ProductDetailsCardLongTitle: Story = {
  args: {
    theme: 'light',
    productDetails: {
      id: 'MLA123456789',
      title:
        'Apple iPhone 11 (64 GB) - Negro | Apple iPhone 11 (64 GB) - Negro | Apple iPhone 11 (64 GB) - Negro | Apple iPhone 11 (64 GB) - Negro',
      price: {
        currency: 'CLP',
        amount: 399,
        decimals: 990,
